...
describe('ExpandableCardComponent', () => {
  ...
  describe('ngAfterViewInit', () => {
    ...
    it('should keep isExpanded true when initiallyExpanded is true', fakeAsync(() => {
    ...
    it('should set isExpanded to false when initiallyExpanded is false', fakeAsync(() => {
  ...
  describe('Template rendering', () => {
    ...
    it('should apply display style to content container', fakeAsync(() => {
      fixture.detectChanges();
      tick();
  ...
  describe('Integration tests', () => {
    it('should start expanded and allow collapsing', fakeAsync(() => {
    ...
    it('should start collapsed when initiallyExpanded is false', fakeAsync(() => {
