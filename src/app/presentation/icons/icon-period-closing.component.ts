...
/**
 * Icon component for the period closing action in the workplace header.
 * Uses NavIconColorService to switch between standard and selection color states.
 */
...
@Component({
  ...
  selector: 'app-icon-period-closing',
  styleUrls: ['./icon.scss'],
  template: ` <svg
    width="24px"
    height="24px"
...
export class IconPeriodClosingComponent {
