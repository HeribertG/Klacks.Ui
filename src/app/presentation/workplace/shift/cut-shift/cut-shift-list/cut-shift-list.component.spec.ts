...
describe('CutShiftListComponent - Time Cut Logic', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: NgbCalendar,
          useValue: jasmine.createSpyObj('NgbCalendar', [
            'getToday',
            'getNext',
          ]),
        },
  ...
  describe('Cut Time Logic Tests', () => {
    ...
    const testCases: TestCase[] = [
      ...
      {
        description:
          'Already Over-Midnight (15:00-07:00) cut at 23:00 → 8h + 8h = 16h',
        parentShift: {
          start: '15:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (15:00-07:00) cut at 03:00 → 12h + 4h = 16h',
        parentShift: {
          start: '15:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (23:00-07:00) cut at 03:00 → 4h + 4h = 8h',
        parentShift: {
          start: '23:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Cut exactly at midnight (20:00-04:00) cut at 00:00 → 4h + 4h = 8h',
        parentShift: {
          start: '20:00',
          end: '04:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Start at midnight (00:00-08:00) cut at 04:00 → 4h + 4h = 8h',
        parentShift: {
          start: '00:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'End at midnight (16:00-00:00) cut at 20:00 → 4h + 4h = 8h',
        parentShift: {
          start: '16:00',
          end: '00:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Early morning shift (04:00-12:00) cut at 08:00 → 4h + 4h = 8h',
        parentShift: {
          start: '04:00',
          end: '12:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Late evening shift (19:00-03:00) cut at 01:00 → 6h + 2h = 8h',
        parentShift: {
          start: '19:00',
          end: '03:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (22:00-06:00) cut at 04:00 → 6h + 2h = 8h',
        parentShift: {
          start: '22:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Morning to evening (05:00-21:00) cut at 13:00 → 8h + 8h = 16h',
        parentShift: {
          start: '05:00',
          end: '21:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (21:00-05:00) cut at 02:00 → 5h + 3h = 8h',
        parentShift: {
          start: '21:00',
          end: '05:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Afternoon shift (13:00-21:00) cut at 17:00 → 4h + 4h = 8h',
        parentShift: {
          start: '13:00',
          end: '21:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Early morning over midnight (03:00-11:00) cut at 07:00 → 4h + 4h = 8h',
        parentShift: {
          start: '03:00',
          end: '11:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          '15-minute precision (23:45-07:15) cut at 03:45 → 4h + 3.5h = 7.5h',
        parentShift: {
          start: '23:45',
          end: '07:15',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (16:00-08:00) cut at 23:30 → 7.5h + 8.5h = 16h',
        parentShift: {
          start: '16:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already Over-Midnight (16:00-08:00) cut at 04:00 → 12h + 4h = 16h',
        parentShift: {
          start: '16:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Full night (20:00-08:00) cut at 00:30 → 4.5h + 7.5h = 12h',
        parentShift: {
          start: '20:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Graveyard shift (00:00-08:00) cut at 04:00 → 4h + 4h = 8h',
        parentShift: {
          start: '00:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Split shift already over midnight (19:00-03:00) cut at 23:00 → 4h + 4h = 8h',
        parentShift: {
          start: '19:00',
          end: '03:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Split shift already over midnight (19:00-03:00) cut at 01:00 → 6h + 2h = 8h',
        parentShift: {
          start: '19:00',
          end: '03:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Long day shift (06:00-18:00) cut at 12:00 → 6h + 6h = 12h',
        parentShift: {
          start: '06:00',
          end: '18:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Evening to morning (18:00-06:00) cut at 00:00 → 6h + 6h = 12h',
        parentShift: {
          start: '18:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already midnight crossing (21:30-05:30) cut at 01:30 → 4h + 4h = 8h',
        parentShift: {
          start: '21:30',
          end: '05:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Short night shift (23:00-03:00) cut at 01:00 → 2h + 2h = 4h',
        parentShift: {
          start: '23:00',
          end: '03:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Multiple cuts scenario 1: (20:00-04:00) cut at 22:00 → 2h + 6h = 8h',
        parentShift: {
          start: '20:00',
          end: '04:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Multiple cuts scenario 2: (22:00-04:00) already cut, cut at 01:00 → 3h + 3h = 6h',
        parentShift: {
          start: '22:00',
          end: '04:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Unusual hours (11:15-19:45) cut at 15:30 → 4.25h + 4.25h = 8.5h',
        parentShift: {
          start: '11:15',
          end: '19:45',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Complex over midnight (17:45-01:15) cut at 23:15 → 5.5h + 2h = 7.5h',
        parentShift: {
          start: '17:45',
          end: '01:15',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          '3-shift rotation morning (06:00-14:00) cut at 10:00 → 4h + 4h = 8h',
        parentShift: {
          start: '06:00',
          end: '14:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          '3-shift rotation afternoon (14:00-22:00) cut at 18:00 → 4h + 4h = 8h',
        parentShift: {
          start: '14:00',
          end: '22:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          '3-shift rotation night (22:00-06:00) cut at 02:00 → 4h + 4h = 8h',
        parentShift: {
          start: '22:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Restaurant split shift (10:00-14:00) cut at 12:00 → 2h + 2h = 4h',
        parentShift: {
          start: '10:00',
          end: '14:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Restaurant evening (17:00-23:00) cut at 20:00 → 3h + 3h = 6h',
        parentShift: {
          start: '17:00',
          end: '23:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Healthcare 12h day (07:00-19:00) cut at 13:00 → 6h + 6h = 12h',
        parentShift: {
          start: '07:00',
          end: '19:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Healthcare 12h night (19:00-07:00) cut at 01:00 → 6h + 6h = 12h',
        parentShift: {
          start: '19:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Security patrol (18:00-06:00) cut at 00:00 → 6h + 6h = 12h',
        parentShift: {
          start: '18:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Airport early shift (04:00-12:00) cut at 08:00 → 4h + 4h = 8h',
        parentShift: {
          start: '04:00',
          end: '12:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Airport late shift (16:00-00:30) cut at 20:00 → 4h + 4.5h = 8.5h',
        parentShift: {
          start: '16:00',
          end: '00:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Retail opening shift (07:30-15:30) cut at 11:30 → 4h + 4h = 8h',
        parentShift: {
          start: '07:30',
          end: '15:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Retail closing shift (13:30-21:30) cut at 17:30 → 4h + 4h = 8h',
        parentShift: {
          start: '13:30',
          end: '21:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Manufacturing rotating shift A (05:00-13:00) cut at 09:00 → 4h + 4h = 8h',
        parentShift: {
          start: '05:00',
          end: '13:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Manufacturing rotating shift B (13:00-21:00) cut at 17:00 → 4h + 4h = 8h',
        parentShift: {
          start: '13:00',
          end: '21:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Manufacturing rotating shift C (21:00-05:00) cut at 01:00 → 4h + 4h = 8h',
        parentShift: {
          start: '21:00',
          end: '05:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Hotel reception day (08:00-16:00) cut at 12:00 → 4h + 4h = 8h',
        parentShift: {
          start: '08:00',
          end: '16:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Hotel reception evening (16:00-00:00) cut at 20:00 → 4h + 4h = 8h',
        parentShift: {
          start: '16:00',
          end: '00:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Hotel reception night (00:00-08:00) cut at 04:00 → 4h + 4h = 8h',
        parentShift: {
          start: '00:00',
          end: '08:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Bakery early morning (03:00-11:00) cut at 07:00 → 4h + 4h = 8h',
        parentShift: {
          start: '03:00',
          end: '11:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Bakery overnight prep (22:00-06:00) cut at 02:00 → 4h + 4h = 8h',
        parentShift: {
          start: '22:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Call center late shift (15:00-23:00) cut at 19:00 → 4h + 4h = 8h',
        parentShift: {
          start: '15:00',
          end: '23:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Call center overnight (23:00-07:00) cut at 03:00 → 4h + 4h = 8h',
        parentShift: {
          start: '23:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Emergency services 24h (06:00-06:00) cut at 18:00 → 12h + 12h = 24h',
        parentShift: {
          start: '06:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already over midnight 24h (18:00-06:00) cut at 00:00 → 6h + 6h = 12h',
        parentShift: {
          start: '18:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Warehouse morning (05:30-13:30) cut at 09:30 → 4h + 4h = 8h',
        parentShift: {
          start: '05:30',
          end: '13:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Warehouse evening (13:30-21:30) cut at 17:30 → 4h + 4h = 8h',
        parentShift: {
          start: '13:30',
          end: '21:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Warehouse night (21:30-05:30) cut at 01:30 → 4h + 4h = 8h',
        parentShift: {
          start: '21:30',
          end: '05:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Transport driver day (06:00-14:00) cut at 10:00 → 4h + 4h = 8h',
        parentShift: {
          start: '06:00',
          end: '14:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Transport driver evening (14:00-22:00) cut at 18:00 → 4h + 4h = 8h',
        parentShift: {
          start: '14:00',
          end: '22:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Transport driver night (22:00-06:00) cut at 02:00 → 4h + 4h = 8h',
        parentShift: {
          start: '22:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Office standard (09:00-17:00) cut at 13:00 → 4h + 4h = 8h',
        parentShift: {
          start: '09:00',
          end: '17:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Office flex early (07:00-15:00) cut at 11:00 → 4h + 4h = 8h',
        parentShift: {
          start: '07:00',
          end: '15:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Office flex late (11:00-19:00) cut at 15:00 → 4h + 4h = 8h',
        parentShift: {
          start: '11:00',
          end: '19:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Cinema evening (16:00-00:30) cut at 20:00 → 4h + 4.5h = 8.5h',
        parentShift: {
          start: '16:00',
          end: '00:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'IT maintenance window (02:00-06:00) cut at 04:00 → 2h + 2h = 4h',
        parentShift: {
          start: '02:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'IT overnight support (19:00-07:00) cut at 23:00 → 4h + 8h = 12h',
        parentShift: {
          start: '19:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Already over midnight IT support (23:00-07:00) cut at 03:00 → 4h + 4h = 8h',
        parentShift: {
          start: '23:00',
          end: '07:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Pharmacy emergency (18:30-08:30) cut at 00:30 → 6h + 8h = 14h',
        parentShift: {
          start: '18:30',
          end: '08:30',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'School janitor early (06:00-14:00) cut at 10:00 → 4h + 4h = 8h',
        parentShift: {
          start: '06:00',
          end: '14:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'School janitor late (14:00-22:00) cut at 18:00 → 4h + 4h = 8h',
        parentShift: {
          start: '14:00',
          end: '22:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Library morning (09:00-17:00) cut at 13:00 → 4h + 4h = 8h',
        parentShift: {
          start: '09:00',
          end: '17:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Library evening (12:00-20:00) cut at 16:00 → 4h + 4h = 8h',
        parentShift: {
          start: '12:00',
          end: '20:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Minimum split case: 23:58 to 00:02 cut at 00:00 → 2min + 2min = 4min',
        parentShift: {
          start: '23:58',
          end: '00:02',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Edge case: Already cut (20:00-02:00) then (20:00-23:00) cut at 21:30 → 1.5h + 1.5h = 3h',
        parentShift: {
          start: '20:00',
          end: '23:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Edge case: Already cut (20:00-02:00) then (23:00-02:00) cut at 00:30 → 1.5h + 1.5h = 3h',
        parentShift: {
          start: '23:00',
          end: '02:00',
          date: new Date('2025-01-01'),
    ...
    testCases.forEach((testCase, index) => {
      it(`Test ${index + 1}: ${testCase.description}`, () => {
        ...
        parentShift.internalFromDate = transformDateToNgbDateStruct(
          testCase.parentShift.date
        );
        ...
        expect(normalizeDate(parentShift.fromDate)).toBe(
          testCase.expected.original.date.toDateString()
        );
        expect(parentShift.cuttingAfterMidnight).toBe(
          testCase.expected.original.cuttingAfterMidnight
        );
        ...
        expect(normalizeDate(addedShift!.fromDate)).toBe(
          testCase.expected.copied.date.toDateString()
        );
        expect(addedShift!.cuttingAfterMidnight).toBe(
          testCase.expected.copied.cuttingAfterMidnight
        );
        ...
        if (testCase.parentShift.expectedDurationMinutes !== undefined) {
          ...
          const totalActualDuration =
            originalActualDuration + copiedActualDuration;

          // Assert original shift duration
          if (
            testCase.expected.original.expectedDurationMinutes !== undefined
          ) {
            expect(originalActualDuration).toBe(
              testCase.expected.original.expectedDurationMinutes,
              `Original shift duration mismatch: expected ${formatDuration(
                testCase.expected.original.expectedDurationMinutes
              )} but got ${formatDuration(originalActualDuration)}`
            );
          }

          // Assert copied shift duration
          if (testCase.expected.copied.expectedDurationMinutes !== undefined) {
            expect(copiedActualDuration).toBe(
              testCase.expected.copied.expectedDurationMinutes,
              `Copied shift duration mismatch: expected ${formatDuration(
                testCase.expected.copied.expectedDurationMinutes
              )} but got ${formatDuration(copiedActualDuration)}`
            );
          }

          // Assert total duration equals original parent duration
          expect(totalActualDuration).toBe(
            testCase.parentShift.expectedDurationMinutes,
            `Total duration mismatch: ${formatDuration(
              originalActualDuration
            )} + ${formatDuration(copiedActualDuration)} = ${formatDuration(
              totalActualDuration
            )}, expected ${formatDuration(
              testCase.parentShift.expectedDurationMinutes
            )}`
          );
        }
  ...
  describe('Cut Date Logic Tests', () => {
    ...
    const cutDateTestCases: CutDateTestCase[] = [
      {
        description:
          'Normal shift split by date - minimum 2 days (08:00-16:00) from 2025-01-01, cut at 2025-01-02',
        parentShift: {
          start: '08:00',
          end: '16:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          'Over-midnight shift split after 3 days (22:00-06:00) from 2025-01-01, cut at 2025-01-04',
        parentShift: {
          start: '22:00',
          end: '06:00',
          date: new Date('2025-01-01'),
      ...
      {
        description:
          '24h shift split after 7 days (00:00-00:00) from 2025-01-01, cut at 2025-01-08',
        parentShift: {
          start: '00:00',
          end: '00:00',
          date: new Date('2025-01-01'),
    ...
    cutDateTestCases.forEach((testCase, index) => {
      it(`Cut Date Test ${index + 1}: ${testCase.description}`, () => {
        ...
        component['selectedShift'] = parentShift;
        component.cutDate = transformDateToNgbDateStruct(
          testCase.cutDate
        ) as any;
  ...
  describe('Cut Staff Logic Tests', () => {
    ...
    cutStaffTestCases.forEach((testCase, index) => {
      it(`Cut Staff Test ${index + 1}: ${testCase.description}`, () => {
        ...
        expect(parentShift.sumEmployees).toBe(
          testCase.expected.original.sumEmployees
        );

        // Assert copied shift
        expect(addedShift).toBeDefined();
        expect(addedShift!.sumEmployees).toBe(
          testCase.expected.copied.sumEmployees
        );
        expect(addedShift!.parentId).toBe(parentShift.id);
  ...
  describe('Cut Task Logic Tests', () => {
    ...
    const cutTaskTestCases: CutTaskTestCase[] = [
      ...
      {
        description:
          'Split 100 tasks: 75 original + 25 copied (large quantity)',
        parentShift: {
          start: '07:00',
          end: '19:00',
          date: new Date('2025-01-01'),
  ...
  describe('ValidateAndCorrectTime Logic Tests', () => {
    ...
    const validateTimeTestCases: ValidateTimeTestCase[] = [
      ...
      {
        description:
          'Normal shift (07:00-15:00): User enters 16:00 → corrected to 14:59',
        shiftSetup: {
          start: '07:00',
          end: '15:00',
      ...
      {
        description:
          'Normal shift (07:00-15:00): User enters 06:00 → corrected to 07:01',
        shiftSetup: {
          start: '07:00',
          end: '15:00',
          isOverMidnight: false,
      ...
      {
        description:
          'Normal shift (07:00-15:00): User enters 07:00 → corrected to 07:01',
        shiftSetup: {
          start: '07:00',
          end: '15:00',
          isOverMidnight: false,
      ...
      {
        description:
          'Normal shift (07:00-15:00): User enters 15:00 → corrected to 14:59',
        shiftSetup: {
          start: '07:00',
          end: '15:00',
          isOverMidnight: false,
      ...
      {
        description:
          'Normal shift (07:00-15:00): User enters 10:00 → valid, no change',
        shiftSetup: {
          start: '07:00',
          end: '15:00',
          isOverMidnight: false,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 08:00 → corrected to 07:00 (closer to end)',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 15:00 → corrected to 23:00 (closer to start)',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 22:00 → corrected to 23:00 (closer to start)',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 23:30 → valid, no change',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 02:00 → valid, no change',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 23:00 → valid, no change (start allowed)',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (23:00-07:00): User enters 07:00 → valid, no change (end allowed)',
        shiftSetup: {
          start: '23:00',
          end: '07:00',
          isOverMidnight: true,
      ...
      {
        description:
          '24h shift (00:00-00:00): User enters 00:00 → corrected to 00:01 (exact start not allowed)',
        shiftSetup: {
          start: '00:00',
          end: '00:00',
          isOverMidnight: false,
      ...
      {
        description:
          '24h shift (00:00-00:00): User enters 12:00 → valid, no change',
        shiftSetup: {
          start: '00:00',
          end: '00:00',
          isOverMidnight: false,
      ...
      {
        description:
          '24h shift (00:00-00:00): User enters 23:59 → valid, no change',
        shiftSetup: {
          start: '00:00',
          end: '00:00',
          isOverMidnight: false,
      ...
      {
        description:
          '24h shift (08:00-08:00): User enters 08:00 → corrected to 08:01 (exact start not allowed)',
        shiftSetup: {
          start: '08:00',
          end: '08:00',
          isOverMidnight: false,
      ...
      {
        description:
          'Over-midnight shift (20:00-04:00): User enters 10:00 → corrected to 04:00 (closer to end)',
        shiftSetup: {
          start: '20:00',
          end: '04:00',
          isOverMidnight: true,
      ...
      {
        description:
          'Over-midnight shift (20:00-04:00): User enters 19:00 → corrected to 20:00 (closer to start)',
        shiftSetup: {
          start: '20:00',
          end: '04:00',
          isOverMidnight: true,
    ...
    validateTimeTestCases.forEach((testCase, index) => {
      it(`Validate Time Test ${index + 1}: ${testCase.description}`, () => {
        ...
        const startTimeStruct = transformStringToOwnTimeStruct(
          testCase.shiftSetup.start
        );
        const endTimeStruct = transformStringToOwnTimeStruct(
          testCase.shiftSetup.end
        );
        ...
        // Set user input time
        component['cutTimeShift'] = transformStringToOwnTimeStruct(
          testCase.userInput
        );
        const originalTime = `${component['cutTimeShift'].hours}:${component[
          'cutTimeShift'
        ...
        // Check result
        const resultTime = `${component['cutTimeShift'].hours}:${component[
          'cutTimeShift'
        ].minutes.padStart(2, '0')}`;
  ...
  describe('Auto-Selection of Child Cut Tests', () => {
    ...
    it('should auto-select new child cut after cut by date', () => {
      // Arrange
      const ngbDateStruct = transformDateToNgbDateStruct(
        new Date('2025-01-03')
      );
      ...
      expect(newSelectedShift!.fromDate?.toDateString()).toBe(
        expectedDate.toDateString()
      ); // Should start at cut date
    });
