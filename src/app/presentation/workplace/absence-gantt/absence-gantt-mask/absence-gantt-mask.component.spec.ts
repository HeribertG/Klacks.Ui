...
describe('AbsenceGanttMaskComponent', () => {
    ...
    let dataManagementBreakService: DataManagementBreakPlaceholderService;
    ...
    beforeEach(async () => {
        ...
        const dataManagementBreakServiceMock = {
            ...
            addBreak: vi.fn(),
            updateBreak: vi.fn().mockReturnValue(Promise.resolve()),
            deleteBreak: vi.fn(),
            readClientId: vi.fn().mockReturnValue(null),
        };
        ...
        dataManagementAbsenceGanttService = TestBed.inject(DataManagementAbsenceGanttService);
        dataManagementBreakService = TestBed.inject(DataManagementBreakPlaceholderService);
    });
