...
export class PdfExportService {
  ...
  exportBreaksTableToPdf(
    ...
    const headers = [
      this.translateService.instant('absence-gantt.absence-gantt-mask.absence-gantt-mask.list.from'),
      this.translateService.instant('absence-gantt.absence-gantt-mask.absence-gantt-mask.list.until'),
      this.translateService.instant('absence-gantt.absence-gantt-mask.absence-gantt-mask.list.absence'),
      this.translateService.instant('absence-gantt.absence-gantt-mask.absence-gantt-mask.list.value'),
      this.translateService.instant('absence-gantt.absence-gantt-mask.absence-gantt-mask.list.note')
    ];
