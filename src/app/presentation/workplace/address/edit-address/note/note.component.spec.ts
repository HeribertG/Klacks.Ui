...
describe('NoteComponent', () => {
  ...
  describe('newAnnotation', () => {
    it('should add new annotation and set it as expanded', (done) => {
  ...
  describe('onDeleteCurrentAnnotation', () => {
    it('should not delete when currentIndex is -1', () => {
      ...
      expect(
        mockDataManagementClientService.removeCurrentAnnotation
      ).not.toHaveBeenCalled();
    });

    it('should delete annotation and reset currentIndex', (done) => {
  ...
  describe('handleKeyDown', () => {
    it('should toggle on Enter key', () => {
      ...
      spyOn(component, 'toggleNoteExpansion');
