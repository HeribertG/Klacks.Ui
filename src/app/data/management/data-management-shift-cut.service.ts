...
import { cloneObject, compareComplexObjects } from 'src/app/helpers/object-helpers';
...
export class DataManagementShiftCutService implements IManageable {
  ...
  constructor() {
    ...
    ManageableServiceRegistry.register('cut-shift', DataManagementShiftCutService);
  }
  ...
  public isDirtyNew = computed(() => {
    ...
    return this.areCutObjectsDirty();
  });
