...
describe('HolidaysListHelper', () => {
    ...
    it('is leap year', () => {
        expect(holidaysHelper.isLeapYear(1852)).toBe(true);
        expect(holidaysHelper.isLeapYear(1892)).toBe(true);
        expect(holidaysHelper.isLeapYear(1912)).toBe(true);
        expect(holidaysHelper.isLeapYear(1936)).toBe(true);
        expect(holidaysHelper.isLeapYear(1968)).toBe(true);
        expect(holidaysHelper.isLeapYear(1988)).toBe(true);
        expect(holidaysHelper.isLeapYear(2020)).toBe(true);
        expect(holidaysHelper.isLeapYear(2032)).toBe(true);
        expect(holidaysHelper.isLeapYear(2048)).toBe(true);
    });

    it('is not leap year', () => {
        expect(holidaysHelper.isLeapYear(1851)).toBe(false);
        expect(holidaysHelper.isLeapYear(1853)).toBe(false);
        expect(holidaysHelper.isLeapYear(1855)).toBe(false);
        expect(holidaysHelper.isLeapYear(1857)).toBe(false);
        expect(holidaysHelper.isLeapYear(1859)).toBe(false);
        expect(holidaysHelper.isLeapYear(1861)).toBe(false);
        expect(holidaysHelper.isLeapYear(1865)).toBe(false);
        expect(holidaysHelper.isLeapYear(1866)).toBe(false);
        expect(holidaysHelper.isLeapYear(1867)).toBe(false);
    });
    ...
    it('should return week 52 for 1st January 2022', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2022, 0, 1))).toEqual(52);
    });

    it('should return week 52 for 31st December 2021', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2021, 11, 31))).toEqual(52);
    });

    it('should return week 1 for 4th January 2021', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2021, 0, 4))).toEqual(1);
    });

    it('should return week 53 for 31st December 2020', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2020, 11, 31))).toEqual(53);
    });

    it('should return week 2 for 6th January 2020', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2020, 0, 6))).toEqual(2);
    });

    it('should return week 1 for 30th December 2019', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2019, 11, 30))).toEqual(1);
    });

    it('should return week 2 for 7th January 2019', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2019, 0, 7))).toEqual(2);
    });

    it('should return week 1 for 1st January 2018', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2018, 0, 1))).toEqual(1);
    });

    it('should return week 1 for 31st December 2018', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2018, 11, 31))).toEqual(1);
    });

    it('should return week 52 for 25th December 2017', () => {
        expect(holidaysHelper.getISO8601WeekNumber(new Date(2017, 11, 25))).toEqual(52);
    });
});
