...
@Injectable()
export class LlmExecutionUserAdminService {

  executeCreateSystemUser(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeDeleteSystemUser(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeListSystemUsers(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeSetUserGroupScope(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
