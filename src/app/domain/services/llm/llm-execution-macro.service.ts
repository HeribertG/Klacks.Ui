...
@Injectable()
export class LlmExecutionMacroService {

  executeCreateMacro(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeDeleteMacro(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
