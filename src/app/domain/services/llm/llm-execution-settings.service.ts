...
@Injectable()
export class LlmExecutionSettingsService {

  executeSettingsGeneralRead(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeSettingsGeneralUpdate(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeOwnerAddressRead(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
  ...
  executeOwnerAddressUpdate(call: ILLMFunctionCall): Observable<ILLMFunctionResult> {
