...
import { Client, ClientContract, Address } from 'src/app/domain/models/client-class';
...
describe('ClientEditService', () => {
  ...
  describe('isValidGroupItems', () => {
    ...
    it('should return true when group items have valid dates', () => {
      ...
      groupItem.internalValidFrom = { year: 2025, month: 1, day: 1 } as NgbDateStruct;
      groupItem.internalValidUntil = { year: 2025, month: 12, day: 31 } as NgbDateStruct;
    ...
    it('should return false when validUntil is before validFrom', () => {
      const client = new Client();
      const groupItem = new ClientGroupItem();
      groupItem.internalValidFrom = { year: 2025, month: 12, day: 31 } as NgbDateStruct;
      groupItem.internalValidUntil = { year: 2025, month: 1, day: 1 } as NgbDateStruct;
      client.groupItems = [groupItem];
    ...
    it('should return true when validUntil is undefined', () => {
      ...
      const groupItem = new ClientGroupItem();
      groupItem.internalValidFrom = { year: 2025, month: 1, day: 1 } as NgbDateStruct;
      groupItem.internalValidUntil = undefined;
      client.groupItems = [groupItem];
