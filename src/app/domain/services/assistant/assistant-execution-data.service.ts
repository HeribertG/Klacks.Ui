...
@Injectable()
export class AssistantExecutionDataService {
  private httpClient = inject(HttpClient);
  private readonly apiBaseUrl = environment.baseUrl;

  executeFillForm(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
    try {
  ...
  executeSubmitForm(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
    try {
  ...
  executeSearchData(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
  ...
  executeGetData(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
  ...
  executeCreateEntity(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
  ...
  executeUpdateEntity(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
  ...
  executeGetCurrentUser(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
    try {
  ...
  executeGetUserPermissions(call: IAssistantFunctionCall): Observable<IAssistantFunctionResult> {
    try {
