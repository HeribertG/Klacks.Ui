...
import { CalendarSelection, SelectedCalendar } from 'src/app/core/calendar-selection-class';
...
describe('CalendarSelectorComponent', () => {
  ...
  beforeEach(async () => {
    const calendarSelectionSpy = jasmine.createSpyObj('DataManagementCalendarSelectionService', [
      'readData',
      'readSChips',
    ...
    const calendarRulesSpy = jasmine.createSpyObj('DataManagementCalendarRulesService', [
      'init',
      'setValue',
    ...
    const modalSpy = jasmine.createSpyObj('ModalService', ['setDefault', 'openModel'], {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: DataManagementCalendarRulesService, useValue: calendarRulesSpy },
    ...
    dataManagementCalendarSelectionService = TestBed.inject(DataManagementCalendarSelectionService) as jasmine.SpyObj<DataManagementCalendarSelectionService>;
    dataManagementCalendarRulesService = TestBed.inject(DataManagementCalendarRulesService) as jasmine.SpyObj<DataManagementCalendarRulesService>;
  ...
  it('should emit openMenu when onIsClosing without dirty filter', () => {
    ...
    dataManagementCalendarSelectionService.isCurrentCalendarSelectionEmptyPlaceholder.and.returnValue(true);
