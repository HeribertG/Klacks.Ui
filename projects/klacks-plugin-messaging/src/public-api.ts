...
export { UserMessengersComponent } from './lib/settings/user-messengers/user-messengers.component';
...
} from './lib/models/user-messenger-contact.model';
...
export { DataUserMessengerContactService } from './lib/services/data-user-messenger-contact.service';
